...
func (x *AuditReviewRequest) Reset() {
	*x = AuditReviewRequest{}
	mi := &file_api_operation_operation_proto_msgTypes[0]
...
func (*AuditReviewRequest) Descriptor() ([]byte, []int) {
	return file_api_operation_operation_proto_rawDescGZIP(), []int{0}
}
...
func (x *AuditReviewReply) Reset() {
	*x = AuditReviewReply{}
	mi := &file_api_operation_operation_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AuditReviewReply) Descriptor() ([]byte, []int) {
	return file_api_operation_operation_proto_rawDescGZIP(), []int{1}
}
...
func (x *AuditAppealRequest) Reset() {
	*x = AuditAppealRequest{}
	mi := &file_api_operation_operation_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AuditAppealRequest) Descriptor() ([]byte, []int) {
	return file_api_operation_operation_proto_rawDescGZIP(), []int{2}
}
...
func (x *AuditAppealReply) Reset() {
	*x = AuditAppealReply{}
	mi := &file_api_operation_operation_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*AuditAppealReply) Descriptor() ([]byte, []int) {
	return file_api_operation_operation_proto_rawDescGZIP(), []int{3}
}

var File_api_operation_operation_proto protoreflect.FileDescriptor

const file_api_operation_operation_proto_rawDesc = "" +
	"\n" +
	"\x1dapi/operation/operation.proto\x12\x10api.operation.v1\x1a\x1cgoogle/api/annotations.proto\x1a\x17validate/validate.proto\"\xd1\x01\n" +
...
var (
	file_api_operation_operation_proto_rawDescOnce sync.Once
	file_api_operation_operation_proto_rawDescData []byte
)

func file_api_operation_operation_proto_rawDescGZIP() []byte {
	file_api_operation_operation_proto_rawDescOnce.Do(func() {
		file_api_operation_operation_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_operation_operation_proto_rawDesc), len(file_api_operation_operation_proto_rawDesc)))
	})
	return file_api_operation_operation_proto_rawDescData
}

var file_api_operation_operation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_api_operation_operation_proto_goTypes = []any{
...
var file_api_operation_operation_proto_depIdxs = []int32{
...
func init() { file_api_operation_operation_proto_init() }
func file_api_operation_operation_proto_init() {
	if File_api_operation_operation_proto != nil {
		return
	}
	file_api_operation_operation_proto_msgTypes[0].OneofWrappers = []any{}
	file_api_operation_operation_proto_msgTypes[2].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_operation_operation_proto_rawDesc), len(file_api_operation_operation_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_api_operation_operation_proto_goTypes,
		DependencyIndexes: file_api_operation_operation_proto_depIdxs,
		MessageInfos:      file_api_operation_operation_proto_msgTypes,
	}.Build()
	File_api_operation_operation_proto = out.File
	file_api_operation_operation_proto_goTypes = nil
	file_api_operation_operation_proto_depIdxs = nil
}
